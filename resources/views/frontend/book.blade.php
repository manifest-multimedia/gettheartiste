            ...
            <form method="POST" action="{{ route('book', $data->id) }}">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input id="artiste_name" class="form-control" name="artiste_name" value="{{$data->name}}" :value="old('artiste_name')" placeholder="{{__('Artiste Name')}}" required disabled />
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="form-group  col-md-6">
                        ...
                        <input type="date" id="appt_date" class="form-control" name="appt_date" :value="old('appt_date')" placeholder="{{__('Appointment Date')}}" required />
                    </div>
