                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" value="{{ $artiste->name }}"
                                            class="form-control" placeholder="Artiste Name">
                                        @error('name')
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label for="slug" class="float-left">Artiste Slug</label>
                                        <input type="text" name="slug" value="{{ $artiste->slug }}"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label for="about" class="float-left">Artiste Profile</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="mt-2 col-md-12">
                                        <img src="{{ $artiste->getFirstMediaUrl('artiste') ?? asset('avatar.jpg') }}"
                                            style="width: 150px" alt="{{ $artiste->name }}">
                                    </div>
                                    <div class="mt-2 col-md-12">
