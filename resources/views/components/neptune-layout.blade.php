    ...
    <body>
        <div class="flex-wrap app header-large align-content-stretch d-flex">
            <div class="app-sidebar">
                <div class="logo">
                    <a href="https://gettheartiste.com" class="logo-icon"><span class="logo-text"
                            style="white-space: nowrap;"></span></a>
                </div>
                <x-app-navigation />
            </div>
